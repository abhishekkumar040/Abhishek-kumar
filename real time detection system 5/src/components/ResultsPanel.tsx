...
export function ResultsPanel({ results, isAnalyzing }: ResultsPanelProps) {
  ...
  // found suspicious features (missing HTTPS, phishing keywords, etc.). An
  // unrecognized domain with zero red flags reads as Legitimate instead.
  const effectiveVerdictKey =
    results.trustLevel === 'unverified' && results.suspiciousFeatures.length === 0
      ? 'verified_legitimate'
      : results.trustLevel;
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <span className={`inline-block px-2 py-0.5 ${
                ...
                {results.trustLevel === 'phishing' ? risk.label : effectiveVerdictKey === 'verified_legitimate' ? 'LEGITIMATE' : 'SUSPICIOUS'}
              </span>
