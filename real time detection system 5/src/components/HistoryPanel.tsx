          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-slate-700/50">
              {history.map((result, idx) => {
                const isCleanUnverified = result.trustLevel === 'unverified' && result.suspiciousFeatures.length === 0;
                const isLegit = result.trustLevel === 'verified_legitimate' || isCleanUnverified;
                return (
